    ...
    foreach ($ks as $k) {
        foreach ($alfas as $alfa) {
            try {
                ...
                $dir = "resultados/metodo-1/knn-$k/alfa-$alfa/$fold-fold";
                $tiempo = 0.0;
                ...
                $salida[] = ["m0", "f$fold", 0.1, 0.5, $k, $alfa, $tiempo, $acc, $pos_pres, $pos_rec, $pos_f1, $neg_pres, $neg_rec, $neg_f1];
            } catch (Exception $e) {
...
$archSal = fopen("resultados/agrupadosPca.csv", "w+");
